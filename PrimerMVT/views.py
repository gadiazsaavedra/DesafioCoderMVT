...
def lista(request) -> HttpResponse:
...
def agregar(request, nombre, apellido, edad, año_nacimiento) -> HttpResponse:
    "función que permite agregar nuevos familiares"
    persona = Familiar_cercano(
        nombre=nombre,
        apellido=apellido,
        edad=edad,
...
def agregar_main(request) -> HttpResponse:
